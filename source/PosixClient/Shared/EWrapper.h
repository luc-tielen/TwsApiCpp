...
enum TickType {                 BID_SIZE,
                                ...
                                LAST_TIMESTAMP,
                                SHORTABLE,
                                FUNDAMENTAL_RATIOS,     /* Missing in ib_insync:tickerTypes.py */
                                RT_VOLUME,
                                HALTED,
                                BID_YIELD,
                                ASK_YIELD,
                                ...
                                REGULATORY_IMBLNC,
                                NEWS,
                                SHORT_TERM_VOLUME_3MINS,
                                SHORT_TERM_VOLUME_5MINS,
                                SHORT_TERM_VOLUME_10MINS,
                                DELAYED_BID,
                                DELAYED_ASK,
                                DELAYED_LAST,
                                DELAYED_BID_SIZE,
...
public:
   ...
   virtual void bondContractDetails( int reqId, const ContractDetails& contractDetails) = 0; /* XXX */
