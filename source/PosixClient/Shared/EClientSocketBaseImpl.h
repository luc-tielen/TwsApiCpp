...
/* Sync with ib_insync/client.py */
const int VERIFY_AND_AUTH_REQ           = 72;
const int VERIFY_AND_AUTH_MSG           = 73;
...
const int REQ_MARKET_DEPTH_EXCHNGS      = 82;
...
/* Sync with ib_insync/decoder.py */
const int VERIFY_AUTH_MESSAGE_API   = 69;
const int VERIFY_AUTH_COMPLETED     = 70;
...
const int SECURITY_DEF_OPTS_PARAMS  = 75;
const int SEC_DEF_OPTS_PARAMS_END   = 76;
const int SOFT_DOLLAR_TIERS         = 77;
const int FAMILY_CODES              = 78;
const int SYMBOL_SAMPLES            = 79;
const int MARKET_DEPTH_EXCHANGES    = 80;
const int TICK_REQ_PARAMATERS       = 81;
...
const int REROUTE_MARKET_DATA_REQ   = 91;
const int REROUTE_MARKET_DEPTH_REQ  = 93;
const int MARKET_RULE               = 94;
const int PROFIT_N_LOSS             = 95;
const int PROFIT_N_LOSS_SINGLE      = 96;
const int HISTORICAL_TICKS          = 97;
const int HISTORICAL_TICKS_BID_ASK  = 98;
const int HISTORICAL_TICKS_LAST     = 99;
const int TICK_BY_TICK              = 100;
const int ORDER_BOUND               = 101;
